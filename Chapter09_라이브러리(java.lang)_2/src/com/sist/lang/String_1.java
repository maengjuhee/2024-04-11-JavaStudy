 ...
 *                             
 *    => 기능 (메소드)
 *       1. public chat charAt(int index) : 원하는 위치의 문자 한개를 가지고 올 떄 사용
 *          문자열은 char[] => index번호는 0부터 사용하다
 *          "Hello java"
 *          0123456789
 *          
 *          charAt(6) ==> 'J'
 ...
 *          => public int lendth()
 *          => "Hello Java"
 *             0123456789 => 10개 => 영문/ 한글 => 글자수 (공백을 포함한다)
 *                                                    --- space 문자
 *          => ..., 비밀번호 확인 / MMS
 ...
 *              ------------> 정형화 (빅데이터) => 통계, 분석
 *            public String replaceAll(String regex, String 변경 문자열)
 *            
 *            ABCDEFG한글입니다
 *            [A-Z], ""
 *            [가-힣], ""
 ...
 *           0123456789
 *                 ---- 6
 *           public String substring(int start, int end) => end 포함이 안된다
 *           "Hello Java"
 *              ---
 *           0123456789
 *             ---
...
public class String_1 {
	...
	public static void main(String[] args) {
		...
		if(s1==s2) // ==는 객첵일 때 => 메모리 주소값을 비교한다 => 실제 문자열만 비교할때는 equals
		{
