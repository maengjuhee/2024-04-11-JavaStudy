 ...
 *                 ***3. clone() : 객체를 복제 => 새로운 메모리를 만들 때 필요한 객체의 내용을 그래돌 복사
...
class Box implements Cloneable
{
	...
	public void setHeight(int height) {
	 ...
	 // throws 문자에 뒤에 붙는 예외클래스는 => RuntimeException 관련은 없다 => 예외처리를 하고 사용한다
	...
	public static void main(String[] args) {
       ...
       /* Sawon s1=new Sawon(1, "홍길동"); // 데이터베이스에 데이터 읽기 / 파일 데이터 읽기
	    ...
	    try {
			 ...
			 System.out.println("box2=>"+box2); // 매모리 주소가 다른 경우에는 새로운 메모리가 생성
			 // 제어를 따로 할 떄 사용
