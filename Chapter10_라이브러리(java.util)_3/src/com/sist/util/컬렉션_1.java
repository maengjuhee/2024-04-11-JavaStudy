...
/*
 *   컬렉션(Collection)
 *     => 데이터가 많은 경우에 처리를 쉽고 효율적으로 관리 가능하게 만드느 자료구조
 ...
 *       ---------- 구현된 클래스
 *       HashSet : 중복 제거
 *       TreeSet : 검색 => 속고 빠르다 (binary search)
 *         => 자바 자체 프로그램 개발
 ...
 *        ---------------------------------------------------------
 *           => 제네릭
 *              => 데이터형을 한 번 통일화 (라이브러리 자체 매개 변수/ 리턴형)
