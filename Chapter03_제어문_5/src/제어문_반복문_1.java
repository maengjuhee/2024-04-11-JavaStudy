 ...
 *    3) 출력물
 *    -----------
 *    조건문 : 프로그램 제어 => 사용자 입력 => 처리 (검색), 맛집, 여행지, 우편번호
 *      = 단일조건문
 *        if => 단독으로 사용
 *        형식) if(조건문) => 부정연산자, 비교연산자, 논리연산자 => 결과값 : true/false
 *             {
 ...
 *           1) for => 2차 for (중첩 for)
 *                    ==================> 코딩 테스트
 *              = 반복횟수 지정 -> 몇 바퀴 돌려라 하면 for문이라 생각해
 *              = 형식)      1     2    4
 *                     for(초기값;조건문;증가식)
 *                     {         |
 *                         반복 수행문 3
 ...
 *                 ----------------- 
 *                              증가식 => 항상 1씩 증가하는 건 아니야
 *                                      i+=3 , i++5 ...
 *                  정수/ 문자
 *              
 *             for(char c='A';c='Z';c++) A~Z
 *             
 *             for(int i=10;i>=0;i--) => 증가 => 최신에 등록된 데이터 읽기
 *             for(char c='Z';c='A';c--)
 */
public class 제어문_반복문_1 {
	...
	public static void main(String[] args) {
        ...
        // true => 수행하는 문장
        // 웹 => 주로 일차 for문 중심 ...
        // 초기값 => 주로 0, 1 시작  int i=0;i<10;i++, int i=1;i<=10;i++
        //                          ---------         ----------
	}
