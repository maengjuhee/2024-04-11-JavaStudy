...
---------- -------------------- ------------------ ---------- ----------
	 ...
	 // public EmpVO empDetailData(int empno)
	  public EmpVO empDetailData(String dong)
	  {
		  ...
		  try
		  {
			  ...
			  String sql="SELECT zipcode,sido,gugun,dong,bunji FROM zipcode WHERE dong="+dong;
			  // 3. 오라클 전송
	  ...
	  public ArrayList<EmpVO> empFind(String dong)
	  {
		  ArrayList<EmpVO> list=new ArrayList<EmpVO>();
		  try
		  {
